...
def main():
    ...
    elif args.name == 'SMAP' or args.name == 'MSL' or args.name.startswith('machine') or args.name == 'NIPS_TS_Water' or args.name == 'NTW':
    ...
    for epoch in range(args.epoch):
        ...
        with torch.no_grad():
            ...
            for x, x_aug, label, idx in test_loader:
                ...
                h_vis, log_prob, h_gcn_test, _, _ = model.test(x, )
            ...
            for x, x_aug, label, idx in train_loader:
                ...
                h_vis, log_prob, h_gcn_train, _, _ = model.test(x,
...
if __name__ == "__main__":
    ...
    mp.freeze_support()   # Windows 下建议加
